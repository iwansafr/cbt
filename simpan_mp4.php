...
$sql = mysqli_query($sqlconn,"update cbt_jawaban set XMulaiV = '$_REQUEST[waktu]', XPutarV='1' where XUserJawab ='$_COOKIE[PESERTA]' and XKodeSoal = '$_REQUEST[soal]' and urut = '$_REQUEST[nomer]' and XTokenUjian = '$_REQUEST[token]'");
}
