		...
		if(this.vpb_files.length > 0)
		{
 			...
 			for(var i = 0; i<this.vpb_files.length; i++)
			{
				...
				if(typeof this.vpb_files[i] != undefined && this.vpb_files[i].name != "")
				{
					...
					else if( vpb_file_to_add == "mp3" || vpb_file_to_add == "wav" || vpb_file_to_add == "ogg" || vpb_file_to_add == "MP3" || vpb_file_to_add == "wma" )
					{
						vpb_file_icon = '<img src="images/music.png" align="absmiddle" border="0" alt="" />';
					}
					...
					else if( vpb_file_to_add == "mp4" || vpb_file_to_add == "mkv")
					{
						vpb_file_icon = '<img src="images/video.png" align="absmiddle" border="0" alt="" />';
					}
