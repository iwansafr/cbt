...
<html>
<head>
<title><?php echo $skull; ?>-CBT | UPLOAD</title>
</head>
...
<div class="panel panel-default panel-small" style="margin-top:20px; width:95%">
						...
						<a href="?modul=file_pendukung"><button type="button" class="btn btn-info btn-small"><i class="fa fa-backward"></i> Kembali</button></a>
