...
<div style="width: 80%; float:right">
   Silahkan Klik logo Excel disamping, untuk <b> download </b> file excel database tugas. 
   ...
   database melalui tool dibawah ini. 
       ...
       <a href="../../file-excel/bee_tugas_temp.xls" target="_blank"><button class="btn btn-success btn-lg btn-small" id="baru" value="Buat" name="baru"><i class="fa fa-cloud-download"></i>
...
<div style="width:75%; margin-top:10px">
    ...
    ?>
                            ...
                            <div class="well">
                            <p><span style="color: #1B06CF;"><?php echo $skull; ?>-CBT </span></p>
                        </div>
                    </div>
                    <!-- /.col-lg-4 -->
                </div>
