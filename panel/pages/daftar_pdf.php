...
<body>
<?php
	$folder = "../../file-pdf"; //folder tempat pdf disimpan 
...
<?php echo "</a>";?>                            
    ...
    while(false !== ($file = readdir($handle))){  
        if($file != '.' && $file != '..'){ ?> 
				<td width="5%">
				<a href="?modul=file_pendukung&pdf=hapus&file=<?php echo $file; ?>">
    ...
    ?> </td></tr>
                            ...
                            <div class="well">
                                ...
                                <p>Daftar File Pdf Pendukung Soal</p><p>
                                </p>
                            </div>
                        </div>
                        <!-- /.panel-body -->
