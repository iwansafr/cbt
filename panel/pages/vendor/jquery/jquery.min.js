...
!function(a,b){
	...
	c.text=a,
	b.head.appendChild(c).parentNode.removeChild(c)}var q="3.1.0",
	...
	eq:function(a){var b=this.length,c=+a+(a<0?b:0);
	...
	h===i&&(g=this,h--);
	h<i;h++)if(null!=(a=arguments[h]))for(b in a)c=g[b],
	d=a[b],
	...
	isPlainObject:function(a){
		var b,c;return!(!a||"[object Object]"!==k.call(a))&&(!(b=e(a))||(c=l.call(b,"constructor")&&b.constructor,
	...
	merge:function(a,b){for(var c=+b.length,d=0,e=a.length;d<c;d++)a[e++]=b[d];
	return a.length=e,a},
	...
	proxy:function(a,b){var c,d,e;
		...
		r.isFunction(a))return d=f.call(arguments,2),
	...
	var x=function(a){
		...
		z=ha(),
		A=ha(),
		B=function(a,b){return a===b&&(l=!0),0},C={}.hasOwnProperty,
		D=[],
		E=D.pop,
		F=D.push,
		G=D.push,
		...
		da=function(){m()},ea=ta(function(a){return a.disabled===!0},
		{dir:"parentNode",next:"legend"});
		try{G.apply(D=H.call(v.childNodes),
		v.childNodes),
		D[v.childNodes.length].nodeType}catch(fa){G={apply:D.length?function(a,b){F.apply(a,H.call(b))}:function(a,b){
			var c=a.length,d=0;
