...
<div style="width: 80%; float:right">
   <br>Silahkan Klik tombol dibawah ini untuk  <b>download</b>  file excel template soal yang dibutuhkan sesuai jenis soal. 
   <br><span style="color: #ff0000;">Jangan ada inputan apapun setelah nomer terakhir</span> Karena akan dibaca dan diacak oleh sistem. 
   <br>Hal ini berakibat beberapa soal menjadi kosong / tidak tampil di lembar ujian CBT.<p>
                        ...
                        <button type="button" class="btn btn-success btn-small"><i class="fa fa-cloud-download"></i> Template Soal Peminatan</button></a>
                        <a href="../../file-excel/bee_soal_agama.xls" target="_blank">
                        <button type="button" class="btn btn-success btn-small"><i class="fa fa-cloud-download"></i> Template Soal Agama</button></a>
                        ...
                        <div class="panel-heading">
							...
							<td align="right">
								...
								<button type="button" class="btn btn-info btn-small"  data-toggle="modal" data-target="#myModal">
									<i class="fa fa-file-o"></i>&nbsp;Buat Bank Soal Baru
								</button><?php }?>
                            </td></tr>
							</table>
                        </div>
