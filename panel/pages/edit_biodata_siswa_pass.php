...
$(document).ready(function(){
	...
	$.ajax({
    type:"POST",
    url:"ubahbiodata_siswa_pass.php",    
    ...
    <div class="left">
    				<div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <tr height="42px"><td width="30%">Nama Siswa&nbsp;</td><td>: <td> &nbsp;&nbsp;&nbsp;<?php echo "$nama"; ?></td><td width="30%"></td></tr>
							<tr height="42px"><td width="30%">Kelas - <?php echo $rombel;?>&nbsp;</td><td>: <td>&nbsp;&nbsp;&nbsp;<?php echo "$kelas - $jurusan"; ?></td><td width="30%"></td></tr>
