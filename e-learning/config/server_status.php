...
// 2. Pilih database
if(!$link){$status_konek = "0";}
else {
	$status_konek = "1";
	mysqli_select_db($database, $link) 
	or die('
	<b><span style="color: #ff0000;">SERVER tidak terhubung ke DataBase SERVER PUSAT</span><br>
	<br>SOLUSI : 
	<br></br>Edit koneksi database BEESMART-CBT dengan tepat</b> >> Langkah :
...
//mysqli_select_db("beesmartv3_rev2", $sqlconn);
